...
export async function bulkUpload(totalFiles = 70, prefix = "") {
...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("Bulk upload başlıyor...");
  // Differential dosyaları yükle
  bulkUpload(70, "diff_medium_").catch(console.error);
}
